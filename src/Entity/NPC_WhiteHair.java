...
public class NPC_WhiteHair extends Entity{
    public NPC_WhiteHair(GamePanel gp) {
        super(gp);
        direction = "down";
        speed = 1;
    ...
    public void getNPCImage(){
        up1=setup("/npc/white_hair_up1",gp.tileSize,gp.tileSize);
        up2=setup("/npc/white_hair_up2",gp.tileSize,gp.tileSize);
        up3=setup("/npc/white_hair_up3",gp.tileSize,gp.tileSize);
        ...
        left1=setup("/npc/white_hair_left1",gp.tileSize,gp.tileSize);
        left2=setup("/npc/white_hair_left2",gp.tileSize,gp.tileSize);
        left3=setup("/npc/white_hair_left3",gp.tileSize,gp.tileSize);
